class Carousel3D extends HTMLElement {
  ...
  renderOut = () => {
    ...
    // Apply radius multiplier if specified
    const radiusMultiplier = parseFloat(this.getAttribute('radius-multiplier')) || 1;
    this.rad = baseRad * radiusMultiplier;
  ...
  attributeChangedCallback(name, oldVal, newVal) {
    ...
    if (Carousel3D.rerenderingAttrs && Carousel3D.rerenderingAttrs.includes(name)) {
