...
import { SolanaIcon, ExternalLinkIcon, ChevronIcon } from '@/shared/icons'
...
export const JackpotVerification: React.FC<JackpotVerificationProps> = ({
  ...
  return (
    <div
      data-id={dataId}
      className="flex-grow px-8 pt-14"
    >
...
function seededRandomBigInt(hash, min, max) {
  ...
  return min + (uintValue % range);
      ...
      {/* Verify Section */}
      <div className="w-[978px] flex flex-col gap-6 mb-9">
        <div>
          ...
          <div className="flex flex-col gap-3">
            <div className="flex gap-3">
              ...
              <button
                ...
                className="h-[44px] px-6 bg-[#6741FF] text-white text-[14px] font-semibold rounded-lg transition-opacity duration-300 hover:opacity-90 flex items-center justify-center"
              >
                Verify
              </button>
            </div>
