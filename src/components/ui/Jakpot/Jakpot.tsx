...
import { gamecards } from "../../data/gamecard_info";
import { UserStats } from "../UserStatsModal/userstats";
import type { UserStatsProps } from "../UserStatsModal/userstats";
      ...
      <div className="relative flex items-start gap-4 mx-auto pl-4 sm:pl-6 lg:pl-8 pr-0">
        <div className="flex-1 flex justify-center">
          <div className="w-full max-w-4xl">
            ...
            <div className="relative mx-auto mb-4 sm:mb-5 lg:mb-6 w-full group">
              ...
              <button
                ...
                className="absolute top-3 right-3 z-20 opacity-0 group-hover:opacity-100 transition-opacity duration-200 bg-black/60 hover:bg-black/80 text-white border border-white/20 rounded-md px-2 py-1 text-xs leading-none flex items-center gap-1"
              >
              ...
              <div className="rounded-2xl backdrop-blur-sm px-3 sm:px-4 py-6 sm:py-8 overflow-hidden" style={{ backgroundColor: "rgba(22,22,22,1)", minHeight: 260 }}>
