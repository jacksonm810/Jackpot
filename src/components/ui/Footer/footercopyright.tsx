export const FooterCopyright = () => {
  return (
    <div className="items-center box-border caret-transparent flex flex-col gap-y-4 justify-between max-w-[1064px] w-full mt-[42px] mx-auto px-4 md:flex-row md:gap-y-0">
      ...
      <button
        type="button"
        className="bg-transparent caret-transparent block leading-[18.4px] text-center p-0"
      >
        <button className="relative text-sm font-medium items-center bg-zinc-800 caret-transparent flex h-10 justify-center leading-5 min-w-10 w-full overflow-hidden px-4 py-0 rounded-lg hover:bg-neutral-700/80">
